...
ARTICLES = ["Roles in a Data Team", "Building a Data Science Team", "Data Science Manager vs Data Science Expert", "Data Engineers Aren't Plumbers",
                    "Starting a Career as a Data Scientist", "Guidelines to Get a Data Engineer Job Against the Odds"]
MODELS = ["ollama/gamma:2b"]
...
def generate_synthetic_data(start_time, end_time):
    ...
    while current_time < end_time:
        ...
        save_conversation(conversation_id, question, answer_data, articles, current_time)
        print(
            f"Saved conversation: ID={conversation_id}, Time={current_time}, Article={articles}, Model={model}"
        )
...
def generate_live_data():
    ...
    while True:
        ...
        save_conversation(conversation_id, question, answer_data, article, current_time)
        print(
            f"Saved live conversation: ID={conversation_id}, Time={current_time}, Article={article}, Model={model}"
        )
